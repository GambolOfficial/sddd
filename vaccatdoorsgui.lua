...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			Topbar = Color3.fromRGB(119, 31, 191),
			Shadow = Color3.fromRGB(0, 255, 255),

			NotificationBackground = Color3.fromRGB(53, 25, 103),
			NotificationActionsBackground = Color3.fromRGB(44, 34, 62),

			TabBackground = Color3.fromRGB(80, 80, 80),
			TabStroke = Color3.fromRGB(85, 85, 85),
			TabBackgroundSelected = Color3.fromRGB(210, 210, 210),
			TabTextColor = Color3.fromRGB(0, 255, 255),
			SelectedTabTextColor = Color3.fromRGB(85, 255, 255),

			ElementBackground = Color3.fromRGB(42, 32, 59),
			ElementBackgroundHover = Color3.fromRGB(60, 46, 84),
			SecondaryElementBackground = Color3.fromRGB(60, 46, 84), -- For labels and paragraphs
			ElementStroke = Color3.fromRGB(0, 255, 255),
			SecondaryElementStroke = Color3.fromRGB(0, 255, 255), -- For labels and paragraphs

			SliderBackground = Color3.fromRGB(119, 31, 191),
			SliderProgress = Color3.fromRGB(119, 31, 191),
			SliderStroke = Color3.fromRGB(144, 46, 255),

			ToggleBackground = Color3.fromRGB(44, 34, 62),
			ToggleEnabled = Color3.fromRGB(0, 255, 255),
			ToggleDisabled = Color3.fromRGB(100, 100, 100),
			ToggleEnabledStroke = Color3.fromRGB(144, 46, 255),
			ToggleDisabledStroke = Color3.fromRGB(125, 125, 125),
			ToggleEnabledOuterStroke = Color3.fromRGB(144, 46, 255),
			ToggleDisabledOuterStroke = Color3.fromRGB(65, 65, 65),

			InputBackground = Color3.fromRGB(44, 34, 62),
			InputStroke = Color3.fromRGB(119, 31, 191),
...
local Rayfield = game:GetObjects("rbxassetid://13151107285")[1]
